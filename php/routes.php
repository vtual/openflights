...
if(! $apid) {
  ...
  if($param) {
    switch(strlen($param)) {
    case 2:
      $sql = "SELECT CONCAT('L', alid) AS apid FROM airlines WHERE iata='" . mysqli_real_escape_string($db, $param) . "'";
      break;
    case 3:
      $sql = "SELECT apid FROM airports WHERE iata='" . mysqli_real_escape_string($db, $param) . "'";
      break;
    case 4:
      $sql = "SELECT apid FROM airports WHERE icao='" . mysqli_real_escape_string($db, $param) . "'";
      break;
    default:
...
$apid = mysqli_real_escape_string($db, $apid);
